...
/**
 * <p>Structure used for storing a rectangle.</p>
 * 
 * <h5>Copyright</h5>
 * 
 ...
 */
public class OORectangle {
    /**
     * <p>The width dimension of the rectangle.</p>
     */
    public int width;
    
    /**
     * <p>The height dimension of the rectangle.</p>
     */
    public int height;
    
    /**
     * <p>Create a new {@link OORectangle} object with the initial value {@code (0, 0)}.</p>
     */
    public OORectangle() {
        this.width = 0;
        this.height = 0;
    ...
    /**
     * <p>Create a new {@link OORectangle} object with specified coordinate values.</p>
     * 
     * @param width The width dimension of the rectangle.
     * @param height The height dimension of the rectangle.
     */
    public OORectangle(int width, int height) {
        this.width = width;
        this.height = height;
    }
}
