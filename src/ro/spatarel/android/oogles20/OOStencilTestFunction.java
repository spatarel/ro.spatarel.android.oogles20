...
/**
 * <p>The list of all possible stencil test functions.</p>
 * 
 * <h5>Copyright</h5>
 * 
 ...
 */
public enum OOStencilTestFunction {
    /**
     * <p>Always passes.</p>
     * 
    ...
    /**
     * <p>Passes if {@code (referenceValue & mask) < (stencil & mask)}.</p>
     * 
    ...
    static OOStencilTestFunction valueOf(int value) {
        for (OOStencilTestFunction someValue : OOStencilTestFunction.values()) {
    ...
    OOStencilTestFunction(int value) {
