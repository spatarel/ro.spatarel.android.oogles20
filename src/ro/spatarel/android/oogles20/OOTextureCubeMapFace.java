...
/**
 * <p>The list of all possible texture cube map faces.</p>
 * 
 * <h5>Copyright</h5>
 * 
 ...
 */
public enum OOTextureCubeMapFace {
    /**
     ...
     * </p>
     */
    POSITIVE_X(OpenGLES20.GL_TEXTURE_CUBE_MAP_POSITIVE_X),
     ...
     * </p>
     */
    NEGATIVE_X(OpenGLES20.GL_TEXTURE_CUBE_MAP_NEGATIVE_X),
     ...
     * </p>
     */
    POSITIVE_Y(OpenGLES20.GL_TEXTURE_CUBE_MAP_POSITIVE_Y),
     ...
     * </p>
     */
    NEGATIVE_Y(OpenGLES20.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y),
     ...
     * </p>
     */
    POSITIVE_Z(OpenGLES20.GL_TEXTURE_CUBE_MAP_POSITIVE_Z),
     ...
     * </p>
     */
    NEGATIVE_Z(OpenGLES20.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
    
    private final int glConstant;
    
    static OOTextureCubeMapFace valueOf(int value) {
        for (OOTextureCubeMapFace someValue : OOTextureCubeMapFace.values()) {
    ...
    OOTextureCubeMapFace(int value) {
