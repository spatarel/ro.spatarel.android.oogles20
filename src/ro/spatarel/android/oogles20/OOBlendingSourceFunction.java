...
/**
 * <p>The list of all possible blending source functions.</p>
 * 
 * <h5>Copyright</h5>
 * 
 ...
 */
public enum OOBlendingSourceFunction {
    /**
     * <p><i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>) = (0, 0, 0, 0)</i>.</p>
     * 
     * <p>Source scale factors are referred to as <i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>)
    ...
    /**
     * <p><i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>) = (1, 1, 1, 1)</i>.</p>
     * 
     * <p>Source scale factors are referred to as <i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>)
     * </i>. All scale factors have range {@code [0, 1]}.</p>
     * 
    ...
    /**
     * <p><i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>) =
    ...
    /**
     * <p><i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>) = (1, 1, 1, 1) -
     * (<sup>R<sub>s</sub></sup>&frasl;<sub>k<sub>R</sub></sub>,
     * <sup>G<sub>s</sub></sup>&frasl;<sub>k<sub>G</sub></sub>,
     * <sup>B<sub>s</sub></sup>&frasl;<sub>k<sub>B</sub></sub>,
     * <sup>A<sub>s</sub></sup>&frasl;<sub>k<sub>A</sub></sub>)</i>.</p>
    ...
    /**
     * <p><i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>) = (i, i, i, 1), where i =
     * <sup>min(A<sub>s</sub>, k<sub>A</sub> - A<sub>d</sub>)</sup>&frasl;<sub>k<sub>A</sub></sub>.</p>
     * 
     * <p>Source scale factors are referred to as <i>(s<sub>R</sub>, s<sub>G</sub>, s<sub>B</sub>, s<sub>A</sub>)
     * </i>. All scale factors have range {@code [0, 1]}.</p>
     * 
     ...
     * m<sub>A</sub>)</i> is the number of red, green, blue and alpha bitplanes.</p>
     * 
     * <p>Reference to the {@link OpenGLES20#GL_SRC_ALPHA_SATURATE} symbolic constant.</p>
     * 
     * <h5>Copyright</h5>
     * 
     * <p>Copyright &copy; 1991-2006 Silicon Graphics, Inc. This document is licensed under the SGI Free Software B
     ...
     * </p>
     */
    SOURCE_ALPHA_SATURATE(OpenGLES20.GL_SRC_ALPHA_SATURATE);
    
    private final int glConstant;
    
    static OOBlendingSourceFunction valueOf(int value) {
        for (OOBlendingSourceFunction someValue : OOBlendingSourceFunction.values()) {
    ...
    OOBlendingSourceFunction(int value) {
